...
Cursor *LanguageLexer::cursor() const
{
...
void LanguageLexer::expect_next(std::string msg)
{
	if (!current_match->matching)
		return;
...
void LanguageLexer::expect_prev(std::string msg)
{
	if (!current_match->matching)
		return;
...
void LanguageLexer::match(std::string str)
{
	if (!current_match->matching)
		return;
	current_match->cursor->skip_ignore();
...
void LanguageLexer::match(std::regex reg)
{
	if (!current_match->matching)
		return;
	current_match->cursor->skip_ignore();
